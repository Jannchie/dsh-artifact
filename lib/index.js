...
Support both themes: define the palette as custom properties on \`:root\` and override them inside \`@media (prefers-color-scheme: dark)\`, so the artifact matches the app the user is reading it in. Keep that override and \`color-scheme\` in agreement — they are what make the page and the browser's own chrome darken together.
...
<style>
  :root {
    ...
    --bg: #fff; --fg: #1a1a1a; --muted: #666; --rule: #e4e4e4;
  }
  @media (prefers-color-scheme: dark) {
    :root { --bg: #17181a; --fg: #e8e8e8; --muted: #9a9a9a; --rule: #2e2f33; }
  }
  body {
